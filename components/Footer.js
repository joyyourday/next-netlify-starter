...
function Fotter () {
    ...
    <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        <a href="./" className="flex title-font font-bold items-center md:justify-start justify-center text-gray-900">
        <Image src='/logo.png' alt='Logo' width={400} height={60} /></a>
     
        <p className="mt-2 mx-6 font-bold text-sm text-gray-500 px-5">Watch & Enjoy Movies 24x7</p>
      </div>
